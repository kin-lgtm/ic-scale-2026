              ...
              <div key={track.number} className="bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg transition-shadow p-6">
                <div className="flex items-start mb-4">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-[#C4B5FD] text-white font-bold text-xl">
                      {track.number}
                    </div>
                  </div>
                  <div className="ml-4">
                ...
                <ul className="space-y-2 ml-16">
                  {track.topics.map((topic, index) => (
                    <li key={index} className="flex items-start">
                      <svg className="h-5 w-5 text-[#C4B5FD] mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-[#C4B5FD] mx-auto"></div>
          </div>

          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-700 leading-relaxed mb-12 text-center">
              IC-SCALE 2026 invites original and unpublished research contributions addressing theoretical, methodological, and applied issues in supply chain and logistics engineering.
            </p>

            {/* Submission Categories */}
            <div className="space-y-8 mb-12">
              <div className="bg-white p-8 rounded-lg border-2 border-[#C4B5FD] shadow-md">
                ...
                <div className="space-y-3 text-gray-700">
                  ...
                  <p><strong>Publication:</strong> Published in the IC-SCALE 2026 Abstract Book (ISBN)</p>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg border-2 border-[#C4B5FD] shadow-md">
                ...
                <div className="space-y-3 text-gray-700">
                  ...
                  <p><strong>Publication:</strong> Accepted papers will be published in the IC-SCALE 2026 Conference Proceedings (ISBN)</p>
            ...
            <div className="bg-white p-8 rounded-lg border-2 border-gray-200 shadow-md mb-12">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-10 w-10 rounded-md bg-[#C4B5FD] text-white">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            {/* Extended Abstracts */}
            <div className="bg-gradient-to-r from-[#C4B5FD]/10 to-white p-8 rounded-lg border-2 border-[#C4B5FD] shadow-md">
              <div className="flex items-start">
                <div className="flex-shrink-0">
                  <div className="w-16 h-16 bg-[#C4B5FD] rounded-lg flex items-center justify-center">
                ...
                <div className="ml-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Extended abstracts will be published in the official <strong>IC-SCALE 2026 Abstract Book</strong> with ISBN. This publication provides a platform for early-stage research, industry case studies, and conceptual frameworks.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-[#C4B5FD]/10 to-white p-8 rounded-lg border-2 border-[#C4B5FD] shadow-md">
              <div className="flex items-start">
                ...
                <div className="ml-6">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Full papers will be published in the <strong>IC-SCALE 2026 Conference Proceedings</strong> with ISBN. These proceedings will feature completed research papers with strong methodological rigor and significant contributions to the field.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-[#C4B5FD]/10 to-white p-8 rounded-lg border-2 border-[#C4B5FD] shadow-md">
              <div className="flex items-start">
                ...
                <div className="ml-6">
                  ...
                  <div className="mt-4 bg-white p-4 rounded-md border border-[#C4B5FD]/30">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md border-2 border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed text-center text-lg">
                IC-SCALE is a newly established conference working towards indexing eligibility. We are committed to maintaining high academic standards and pursuing recognition from major indexing databases in future editions.
              </p>
            </div>
            {/* Call to Action */}
            <div className="text-center bg-gradient-to-r from-[#C4B5FD]/10 to-white p-8 rounded-lg border-2 border-[#C4B5FD]">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to Submit?</h3>
              <p className="text-gray-700 mb-6">Submission portal will be announced soon</p>
              <button className="bg-[#C4B5FD] text-white px-8 py-3 rounded-lg hover:bg-[#B4A5ED] transition-colors font-semibold">
                Coming Soon
              </button>
            </div>
          </div>
