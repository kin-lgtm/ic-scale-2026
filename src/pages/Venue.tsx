      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <div className="bg-gradient-to-br from-[#C4B5FD]/10 to-white p-8 rounded-lg border-l-4 border-[#C4B5FD] mb-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Conference Venue</h2>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      <svg className="h-6 w-6 text-[#C4B5FD]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            <div className="bg-white p-8 rounded-lg shadow-md border-l-4 border-[#C4B5FD]">
