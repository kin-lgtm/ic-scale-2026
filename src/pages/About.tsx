        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              The International Conference on Supply Chain and Logistics Engineering (IC-SCALE 2026) is an international academic forum organized by the University of Moratuwa, Sri Lanka. IC-SCALE is designed to bring together researchers, industry practitioners, and policymakers to exchange knowledge, present cutting-edge research, and discuss future directions in supply chain and logistics engineering.
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md border-2 border-[#C4B5FD]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-6xl mx-auto mb-12">
            ...
            <div className="flex justify-center">
              <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-[#C4B5FD] hover:shadow-xl transition-shadow max-w-md">
                <div className="flex flex-col items-center text-center">
                  <div className="relative mb-4">
                    <div className="absolute inset-0 bg-[#C4B5FD]/30 rounded-full blur-xl"></div>
                    <img 
                      src={amilaImage} 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
                  <div className="flex flex-col items-center text-center">
                    <div className="w-24 h-24 bg-gradient-to-br from-[#C4B5FD]/20 to-gray-100 rounded-full flex items-center justify-center mb-3 border-2 border-[#C4B5FD]/30">
                      <svg className="w-12 h-12 text-[#C4B5FD]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
