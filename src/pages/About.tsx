export default function About() {
  const advisoryCommittee = [
    ...
    { name: "Prof. Amal S. Kumarage", title: "Emirates Professor\nUniversity of Moratuwa" },
    { name: "Prof. A.A.D.A.J. Perera", title: "Professor \nUniversity of Moratuwa" },
    { name: "Dr. P.T.R.S. Sugathadasa", title: "Senior Lecturer Grade I, University of Moratuwa" },
    { name: "Eng. (Dr.) T. Sivakumar", title: "Senior Lecturer Grade I, University of Moratuwa" },
    { name: "Dr. L.C.I. Sigera", title: "Senior Lecturer Grade I, University of Moratuwa" },
    { name: "Dr. W.W.A.S. Fernando", title: "Senior Lecturer Grade I, University of Moratuwa" },
    { name: "Mrs. G.M.B.P. Abeysekara", title: "Senior Lecturer Grade II, University of Moratuwa" },
    { name: "Dr. B.D. Hettiarachchi", title: "Senior Lecturer Grade II, University of Moratuwa" },
    { name: "Dr. J.I. Sudusinghe", title: "Senior Lecturer Grade II, University of Moratuwa" }
  ];
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#492B6F] p-6 rounded-lg shadow-md border-2 border-[#492B6F]">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-white">Advance supply chain and logistics engineering research</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#492B6F] p-6 rounded-lg shadow-md border-2 border-[#492B6F]">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-white">Promote engineering-driven and analytical approaches to logistics problems</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#492B6F] p-6 rounded-lg shadow-md border-2 border-[#492B6F]">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-white">Bridge academia, industry, and public policy</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#492B6F] p-6 rounded-lg shadow-md border-2 border-[#492B6F]">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-white">Encourage sustainable, resilient, and socially responsible supply chains</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#492B6F] p-6 rounded-lg shadow-md border-2 border-[#492B6F]">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-white">Foster digitalization, analytics, AI, and decision-support systems</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#492B6F] p-6 rounded-lg shadow-md border-2 border-[#492B6F]">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <p className="text-white">Support postgraduate students, early-career researchers, and regional collaboration</p>
                </div>
              </div>
            </div>
          </div>
