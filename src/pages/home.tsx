        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-[#C4B5FD]">Supply Chain and Logistics Engineering</span>
            </h1>
            ...
            <p className="text-gray-600 max-w-4xl mx-auto mb-10 text-lg leading-relaxed">
              IC-SCALE 2026 is an international forum dedicated to advancing research and practice in supply chain and logistics engineering, with a strong emphasis on emerging economies and South Asian contexts.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/call-for-papers" 
                className="bg-[#C4B5FD] text-white px-8 py-4 rounded-lg hover:bg-[#B4A5ED] transition-all transform hover:scale-105 font-semibold text-lg shadow-lg"
              >
                Call for Papers
              </Link>
              <Link 
              ...
              <Link 
                to="/registration" 
                className="border-2 border-[#C4B5FD] text-[#C4B5FD] px-8 py-4 rounded-lg hover:bg-[#C4B5FD] hover:text-white transition-all transform hover:scale-105 font-semibold text-lg"
              >
                Registration
              </Link>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <div className="w-24 h-1 bg-[#C4B5FD] mx-auto mb-6"></div>
          </div>
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              The International Conference on Supply Chain and Logistics Engineering (IC-SCALE 2026) is a newly established international conference hosted by the University of Moratuwa, Sri Lanka. The conference aims to promote rigorous, engineering-oriented research that addresses structural, operational, and technological challenges in modern supply chains and logistics systems.
            </p>
            <Link 
              to="/about" 
              className="inline-block bg-[#C4B5FD] text-white px-8 py-3 rounded-lg hover:bg-[#B4A5ED] transition-colors font-semibold"
            >
              Read More
            </Link>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-lg shadow-md border-2 border-[#C4B5FD]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We are grateful to our sponsors for their generous support in making IC-SCALE 2026 possible
            </p>
          </div>
