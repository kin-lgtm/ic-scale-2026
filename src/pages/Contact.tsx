                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      <div className="w-12 h-12 bg-[#492B6F]/20 rounded-lg flex items-center justify-center">
            ...
            <div>
              <div className="bg-gray-50 p-8 rounded-lg border-2 border-gray-200">
                ...
                <div className="space-y-4">
                  ...
                  <button className="w-full bg-[#492B6F] text-white px-6 py-3 rounded-lg hover:bg-[#B4A5ED] transition-colors font-semibold">
                    Send Message
                  </button>
                </div>  
              </div>
