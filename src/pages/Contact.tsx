      ...
      <section ref={section1.elementRef} className={`py-16 animate-on-scroll ${section1.isVisible ? 'visible' : ''}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:items-end">
            ...
            <div className="flex flex-col">
              <div className="bg-gray-50 p-8 border-2 border-gray-200 h-full">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Get in Touch</h2>
                
                {/* Success Message */}
                {formStatus === 'success' && (
                  <div className="mb-6 p-4 bg-[#C4B5FD]/10 border border-[#C4B5FD]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      name="name"
                      required
                      className="w-full px-4 py-2 border border-gray-300 focus:ring-2 focus:ring-[#492B6F] focus:border-transparent"
